  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(fetchProducts.fulfilled, (state, action) => {
        ...
        state.data = products;
        state.total = total;
        state.favoriteProducts = products.filter((item) =>
